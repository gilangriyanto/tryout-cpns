        ...
        <div className="row justify-cotent-center m-0 ms-3">
          <Row className="justify-content-between">
            <Col className="col-lg-5 col-12">
              <h2 className="text-white fw-bold">Dapatkan Info Terupdate bersama IKUT CPNS</h2>
            </Col>
            <Col className="col-lg-6 col-12">
            <form className="bg-white rounded d-flex justify-content-end p-2">
                <div className="w-100">
                  <input type="text" className="form-control border-0" id="search" placeholder=""/>
                </div>
                <div class="col-auto">
                  <button type="submit" className="btn btn-dark text-white">Mulai Sekarang</button>
                </div>
            </form>
            </Col>
          </Row>

          <Row className="py-5 justify-content-between" style={{ borderBottom: "2px white solid" }}>
              ...
              <div className="row">
                <div className="col">
                  <a
                    ...
                    <img className="img-fluid" src="/logo-gascpns-putih.png" alt="Logo" />
              ...
              <div className="row">
                <div className="col-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      <a href="/" className="text-decoration-none text-white">Kebijakan Layanan</a>
                    </li>
                    <li className="mb-2">
                      <a href="/" className="text-decoration-none text-white">Career</a>
                    </li>
                    <li className="mb-2">
                      <a href="/testimoni" className="text-decoration-none text-white">Testimoni</a>
                    </li>
                    <li className="mb-2">
                      <a href="/" className="text-decoration-none text-white">Daftar Kelas</a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-4">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li className="mb-2">
                      <a href="/" className="text-decoration-none text-white">Telegram</a>
                    </li>
                    <li className="mb-2">
                      <a href="/" className="text-decoration-none text-white">Email</a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      <a className="text-decoration-none text-white">Jakarta, Indonesia</a>
                    </li>
                  </ul>
                </div>
